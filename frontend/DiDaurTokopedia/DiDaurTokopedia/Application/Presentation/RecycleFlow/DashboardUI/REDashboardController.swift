...
public final class REDashboardController: UIViewController {
    ...
    func setupTableView() {
        ...
        self._view.tableView.register(DashboardCell.self, forCellReuseIdentifier: DashboardCell.identifier)
...
private extension REDashboardController {
    ...
    func setupRecycleButton() {
        self._view.setRecycleButtonEnable(UserPreference.shared.isWaiting ?? false)
